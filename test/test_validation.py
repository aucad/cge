...
def test_no_constraints():
    ...
    result = Validation(ori).enforce(adv)
...
def test_immutable_all():
    ...
    result = Validation(ori, immutable=[0, 1, 2, 3]).enforce(adv)
...
def test_immutable_1():
    ...
    result = Validation(ori, immutable=[1]).enforce(adv)
...
def test_immutable_2():
    ...
    result = Validation(ori, immutable=[2, 5]).enforce(adv)
    assert (result == exp).all()
...
def test_bin_feature():
    ...
    result = Validation(ori, constraints=constraints).enforce(adv)
    assert (result == exp).all()
