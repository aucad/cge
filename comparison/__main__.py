...
def run_cpgd_attack(X, y, mpipe, constraints, enable):
    attack = CPGD(
        mpipe,
        constraints,
        norm=2,
...
if __name__ == '__main__':
    ...
    model_pipeline = Pipeline(steps=[
        ...
        ("model", model)])
    run_cpgd_attack(x_clean, y_clean, model_pipeline, constr, True)
    run_cpgd_attack(x_clean, y_clean, model_pipeline, constr, False)
